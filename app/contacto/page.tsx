    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative w-full mt-20 bg-[#1a1a1a] py-16">
        <div className="container mx-auto px-4 md:px-12 lg:px-20">
          ...
          <p className="text-xl text-gray-300">Estamos para ayudarte</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+54 11 XXXX-XXXX</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@totalproteccion.com.ar</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold mb-1">Horario de Atencion</h3>
                    <p className="text-gray-600">Lunes a Viernes: 8:00 - 18:00</p>
                    <p className="text-gray-600">Sabados: 8:00 - 13:00</p>
                  </div>
                </div>
              </div>
              ...
              {/* Social Media */}
              <div className="mt-8">
                <h3 className="font-bold mb-4">Seguinos en redes</h3>
                <div className="flex gap-4">
                  <a href="#" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-red-100 transition">
