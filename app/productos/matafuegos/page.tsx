      ...
      <section className="py-16 bg-gradient-to-r from-[#8B0000] to-[#c41e3a]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="https://wa.me/5492995484575?text=Hola!%20Estuve%20viendo%20la%20guía%20de%20matafuegos%20y%20necesito%20asesoramiento%20para%20elegir%20el%20extintor%20correcto."
              target="_blank"
