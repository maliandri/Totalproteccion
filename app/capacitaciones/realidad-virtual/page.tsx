...
const beneficios = [
  {
    ...
    titulo: 'Sala VR equipada',
    descripcion: 'Contamos con una sala exclusiva equipada con tecnologia de ultima generacion',
  },
  {
    icono: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-white/90 mb-8 max-w-xl">
                Entrenamiento <strong className="text-orange-400">inmersivo y seguro</strong> en nuestra sala VR.
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500 to-orange-600">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Visitanos en nuestra sala VR exclusiva. La realidad virtual permite practicar situaciones de emergencia
