            ...
            {temas.map((tema, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-red-600 transition-colors">
                  ...
                  <div>
                    <h3 className="font-bold text-xl mb-2 group-hover:text-red-600 transition-colors">{tema.title}</h3>
                    <p className="text-gray-600">{tema.description}</p>
                  </div>
                </div>
              </Link>
            ))}
